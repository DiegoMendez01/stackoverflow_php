...
<section class="hero-area bg-white shadow-sm overflow-hidden">
    ...
    <div class="container">
        <div class="hero-content pt-80px pb-80px">
            <h2 class="section-title">Nueva Pregunta</h2>
            ...
            <div class="col-lg-8">
                ...
                <form method="post" id="mnt_askquestion" class="card-body">
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                <select class="select-container select--container" data-placeholder="Seleccionar Categoria">
                                    <option selected="" value="">Seleccionar Categoria</option>
                                    <option value="1">Tecnologia</option>
                                    <option value="2">Infraestructura IT</option>
                                </select>
                            </div>
                        </div>
