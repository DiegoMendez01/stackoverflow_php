...
<head>
    ...
    <title>AppOverflow | Nueva Pregunta</title>
</head>
<body>

<!-- start cssload-loader -->
<?php require_once("views/html/preloader.php") ?>
<!-- end cssload-loader -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check custom-checkbox mb-1">
                                    ...
                                    <label class="form-check-label" for="youAgreeCheckBox">
                                        By asking your question, you agree to the <a href="privacy-policy.html" class="text-color hover-underline">Privacy Policy.</a>
                                    </label>
                                </div>
                            </div>
                            <div class="btn-box">
                            ...
                            <div class="card">
                                <div class="card-header" id="headingOne">
                                    <button class="btn btn-link fs-15" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                       <span><span class="text-color pe-2 fs-16">1.</span> Summarize the problem</span>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <button class="btn btn-link collapsed fs-15" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        <span><span class="text-color pe-2 fs-16">2.</span> Describe what you’ve tried</span>
                                        <i class="la la-angle-down collapse-icon"></i>
                                    </button>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <button class="btn btn-link collapsed fs-15" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                        <span><span class="text-color pe-2 fs-16">3.</span> Show some code</span>
                                        <i class="la la-angle-down collapse-icon"></i>
                                    </button>
                                </div>
...
<?php require_once("views/html/ctaarea.php") ?>

<?php require_once("views/html/footer.php") ?>

<?php require_once("views/html/backTop.php") ?>

<?php require_once("views/html/loginModal.php") ?>

<?php require_once("views/html/signUpModal.php") ?>

<?php require_once("views/html/recoverModal.php") ?>

<?php require_once("views/html/js.php") ?>
</body>
</html>